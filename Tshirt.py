...
class Tshirt(Clothes):
    #Line 5-7 : Constructor which is similar to that of Clothes but have  one parameter sleeve
    def __init__(self,price,material,numberofpieces, name,sleeve):
        ...
        #Line 9-10 : function used to set sleeve(actually it isn't uaed in this program)
        def set_sleeve(self,sleve):
            self.__sleeve=sleeve
