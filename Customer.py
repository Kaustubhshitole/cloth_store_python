#Customerr Class Section
#Line 3 : used to import ABC and abstractmethod which are used in abstract class such as class Customer
...
class Customer(ABC):
    ...
    def __init__(self,name,age,money,ID):
        ...
        def set_money(self,money):
            self.__money=money
        #Line 20-21: finction used to get money
        def get_money(self):
            return self.__money
        ...
        #Line 29-30: fuction used to get name
        def get_name(self):
            return self.__name
